...
function MainSlider() {
  ...
  return (
    <Carousel fade style={{ borderRadius: "20px", padding: "20px" }}>
      <Carousel.Item>
        <img
          src="https://nest-frontend-v6.netlify.app/assets/imgs/slider/slider-2.png"
          height={500}
          text="First slide"
        ...
        <Carousel.Caption style={{ color: "#253D4E", marginBottom: "30vh" }}>
          ...
          >
            Fresh Vegetables <span>Big discount</span>{" "}
          </p>
          <p
            style={{
              fontSize: "33px",
      ...
      <Carousel.Item>
        <img
          src="https://nest-frontend-v6.netlify.app/assets/imgs/slider/slider-1.png"
          height={500}
          text="Second slide"
          style={{ borderRadius: "50px 50px 50px 50px" }}
        />
        <Carousel.Caption style={{ color: "#253D4E", marginBottom: "30vh" }}>
          ...
          >
            Sign up for the daily newletter.
          </p>
