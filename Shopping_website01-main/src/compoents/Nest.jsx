          ...
          <Col xs={5} className="me-5 mt-2">
            <Col>
              <FloatingLabel
                ...
                label="Search-engine"
                style={{ marginTop: "30px", marginLeft: "-6vw", width: "45vw" }}
              >
          ...
          <Col style={{ display: "flex" }}>
            <div style={{ marginLeft: "0vw", marginTop: " 56px" }}>
              <Badge badgeContent={3} color="success">
                <img
                  src="https://nest-frontend-v6.netlify.app/assets/imgs/theme/icons/icon-compare.svg"
                  alt=""
                />
              </Badge>
              <span>Compare</span>
            ...
            <div style={{ marginLeft: "4vh", marginTop: "56px" }}>
              <Badge badgeContent={6} color="success">
                <img
                  src="https://nest-frontend-v6.netlify.app/assets/imgs/theme/icons/icon-heart.svg"
                  alt=""
                />
              </Badge>
              <span>Whilist</span>
            ...
            <div style={{ marginLeft: "4vh", marginTop: "56px" }}>
              <Badge badgeContent={2} color="success">
                <img
                  src="https://nest-frontend-v6.netlify.app/assets/imgs/theme/icons/icon-cart.svg"
                  alt=""
                />
              </Badge>
              <span> Cart</span>
            ...
            <div style={{ marginLeft: "3vh", marginTop: "56px" }}>
              <img
                className="mx-3"
                src="https://nest-frontend-v6.netlify.app/assets/imgs/theme/icons/icon-user.svg"
                alt=""
              />
              <span>Account</span>
            </div>
