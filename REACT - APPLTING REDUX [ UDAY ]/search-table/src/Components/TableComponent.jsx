...
function TableComponent({ products }) {
  ...
  return (
    <div className="container mt-2 p-2 justify-content-center text-center">
            ...
            <tr key={index}>
              ...
              <td>
                {editIndex === index ? (
                  <>
                    <button
                      className="btn btn-success mx-2 w-50 mb-2"
                      onClick={() => handleSaveEdit(index)}
                    >
                      Save
                    </button>
                    <button
                      className="btn btn-secondary mx-2 w-75 mb-2"
                  ...
                  <>
                    <button
                      className="btn btn-primary mx-2 w-50 mb-2"
                      onClick={() => handleEdit(index)}
                    >
                      Edit
                    </button>
                    <button
                      className="btn btn-danger mx-2 w-50 mb-2"
